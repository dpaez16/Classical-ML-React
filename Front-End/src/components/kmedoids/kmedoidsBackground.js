...
export const KMedoidsBackground = _ => {
    return (
        <div className='kmedoids__background'>
            ...
            <p>
                <InlineMath math='k' />-medoids clustering is an unsupervised
                algorithm that acts nearly similar to <InlineMath math='k' />-means
                clustering. <InlineMath math='k' />-medoids is not limited 
                to using squared euclidean distance for its distance metric 
                (unlike <InlineMath math='k' />-means). Also it picks a data point to 
                serve as the "center"/"medoid", not the mean of a cluster.
                Like <InlineMath math='k' />-means, <InlineMath math='k' />-medoids tries
                to also minimize the below function:
            </p>
